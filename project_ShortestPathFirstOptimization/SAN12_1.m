...
[w_old ,oldCost]=networkCost12(w_old);
min_cost=oldCost;
...
while T>=tlb & min_cost>clb
   for counter=1:cub
      ...
      [w_new , newCost]=networkCost12(w_new);
...
cccc=findobj(gcbf,'Tag','cost');
set(cccc,'String',min_cost);
nnnn=findobj(gcbf,'Tag','number');
set(nnnn,'String',number);
